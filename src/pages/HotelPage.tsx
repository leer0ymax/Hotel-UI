...
import { roomsApi, parseImageUrls } from '../features/rooms/roomApi';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-blue-900 mb-2">Find Your Perfect Stay</h1>
          <p className="text-black-600">Discover  hotels with BOOKER</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="budget">Budget (Below KSH 5,000)</option>
                <option value="mid">Mid-Range (Between KSH 5,000 - 15,000)</option>
